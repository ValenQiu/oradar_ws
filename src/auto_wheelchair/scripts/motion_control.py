...
# this is the motion control code for using different safety/warning distance
    ...
    def pack_message(self, dist, angle):
        ...
        if not self.backward_flag:
            ...
            if dist > self.R:
                ...
                if self.stop_motion_flag is not True:
                    # when something enter the stop range while moving forward
                    if 0 < angle < 50 or 310 < angle < 360:
                        # if the object is in front of the wheelchair, stop and reverse
                        linear_speed = 0
                        angular_speed = 0
                        motion.linear.x = linear_speed
                        motion.angular.z = angular_speed
                    ...
                    # the stop flag has been triggered, moving inverse
                    linear_speed = -1
                    if 30 < angle < 150:
                        angular_speed = 1
                    elif 210 < angle < 330:
        ...
        # reverse the motion
            ...
            if dist > self.R:
                ...
                if self.stop_motion_flag is not True:
                    # when something enter the stop range while moving backward
                    if 140 < angle < 220:
                        # when something is on the back of the wheelchair
                        linear_speed = 0
                        angular_speed = 0
                        motion.linear.x = linear_speed
                        motion.angular.z = angular_speed
                        ...
                        # when the object is on the left
                        linear_speed = -1
                        angular_speed = -1
                    
                    elif 220 < angle < 310:
                        # when the object is on the right
                        linear_speed = -1
                        angular_speed = 1
