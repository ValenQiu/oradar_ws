...
class ObjectDetection:
    def __init__(self):
        ...
        self.offset_x = rospy.get_param("~offset_x", 0.3)
        self.offset_y = rospy.get_param("~offset_y", 0.3)
        ...
        self.publisher = rospy.Publisher(self.topic_published, PoseStamped, queue_size=10)
    ...
    def detect_callback(self, msg):
        ...
        object_detected.header.frame_id = "laser"
